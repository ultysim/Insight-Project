...
def Run_MMP(mixture_weight, handicap):
    ...
    output_dir = 'data/'+time+'_'+str(MIXTURE_WEIGHT)
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Please input a float for the mixture weight")
    assert 0.0 < mixture_weight, "Mixture weight must be positive"
    try:
        handicap = int(sys.argv[2])
    except ValueError:
        print("Please input an int for the handicap")

    Run_MMP(mixture_weight, handicap)
